...
restaurante_DOM.chef='Emerson'
restaurante_DOM.avaliação='4,5 estrelas Michel'
...
#atividade 3
restaurante_DOM=Restaurante('D.O.M','Gourmet',' Emerson','4,5 estrelas Michelin')
#atividade 4
...
cliente1=Cliente('Bryan',22, '129.897.655-77')
